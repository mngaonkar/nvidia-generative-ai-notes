...
- [Chain of Thought Examples](docs/cot-examples.md)
...
- [Checkpoint Translation](docs/checkpoint-translation.md)

## Model Optimization
- [Quantization](docs/quantization.md)
- [TensorRT-LLM](docs/tensorrt-llm.md)
...
- [NeMo Aligner](docs/nemo-aligner.md)
...
## Safe AI
- [NeMo Guardrails](docs/nemo-guardrails.md)
